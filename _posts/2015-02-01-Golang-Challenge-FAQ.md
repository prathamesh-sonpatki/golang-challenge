...
* You can enter the challenge by posting your solution details only on 14th or 15th of the same month [here](https://github.com/IndianGuru/Golang-Challenge-1). No new solutions will be accepted after that.
* The Go working solution(s) should be clear-cut, follow Go conventions and still be easy to understand.
* On the 16th of that month, all the solutions will be thrown open for everyone to see, comment upon and cast votes. 
