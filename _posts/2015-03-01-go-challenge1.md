...
* Create a [secret gist](https://gist.github.com/) of your code (using language Go) and **share the link with satish [at] joshsoftware.com before the 16th of the month**. No new solutions will be accepted after that. Also send **your country of residence, twitter id and any explanation of your code (if needed)**. We will copy your solution and give it to the evaluation team therefore please ensure that it's your final solution. **Note**: Avoid sharing your secret gist url with anyone else; if your solution becomes available to the general public it might impact evaluation of your submission.
