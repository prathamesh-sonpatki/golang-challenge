...
* Some of the participants blogged about their Go challenge experience: [Doug Cichon](http://www.codeforthought.net/approaching-golang-challenge-one), [Jason Gade](http://bravetinsoldier.blogspot.in/2015/03/lessons-learned-from-first-go-challenge.html), [Tobias Schoknecht](https://www.sysorchestra.com/2015/03/24/the-go-challenge-a-fun-way-to-learn-and-improve/)
