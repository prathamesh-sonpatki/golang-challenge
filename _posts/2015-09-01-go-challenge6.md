...
* Fork this [repo](https://github.com/golangchallenge/gc6). The forked repo should be private, only accessible to you till the end of the challenge. You could use any of these [Free GitHub Alternatives for Private Repositories](http://toppersworld.com/top-10-free-github-alternatives-for-private-repositories/).
